 ...
 * <p>Esta clase gestiona las propiedades de un velero.</p>
 * <p>Está diseñada para su uso en simulaciones de navegación, regatas y otras
 * aplicaciones que requieran el modelado de veleros en un entorno de
 * navegación.</p>
 *
 * @author José Bueno Cruz
 */
public class Velero1 {
 ...
 */
    ...
    // ATRIBUTOS DE OBJETO
    // ------------------------------------------------------------------------
    // Atributos constantes durante la vida del velero
     ...
     */
    public Velero1(String nombre, int numDeMastiles, int numMaxDeTripulantes) throws NullPointerException, IllegalArgumentException {
        ...
        if (numDeMastiles < Velero1.MIN_MASTILES || numDeMastiles > MAX_MASTILES) {
            throw new IllegalArgumentException(String.format("El número de mástiles debe estar entre %d y %d.", Velero1.MIN_MASTILES, Velero1.MAX_MASTILES));
        }

        // Comprobación entrada número máximo de tripulantes
        if (numMaxDeTripulantes < Velero1.MIN_TRIPULANTES) {
            throw new IllegalArgumentException(String.format("El número de tripulantes debe ser, como mínimo, %d.", Velero1.MIN_TRIPULANTES));
        }
        ...
        this.nombreDelPatron = Velero1.PATRON_POR_DEFECTO;
        this.rumbo = Velero1.RUMBO_POR_DEFECTO;
        // Incrementación atributo variable de clase
        Velero1.numDeVelerosClase++;
    }
     ...
     */
    public Velero1() {
        this(String.format("Velero %d", Velero1.numDeVelerosClase + 1), Velero1.MIN_MASTILES, Velero1.MIN_TRIPULANTES);
    }

    // Método fábrica.
    public static Velero1[] crearArrayVelero(int cantidadDeVeleros) {
        ...
        // 
        Velero1[] arrayVeleros = new Velero1[cantidadDeVeleros];
        for (int i = 0; i < cantidadDeVeleros; i++) {
            arrayVeleros[i] = new Velero1();
        }
        return arrayVeleros;
    }
    ...
    public static int getNumBarcos() {
        return Velero1.numDeVelerosClase;
    }
    ...
    public static int getNumBarcosNavegando() {
        return Velero1.numDeVelerosNavegandoClase;
    }
    ...
    public static double getTiempoTotalNavegacion() {
        return Velero1.tiempoTotalDeNavegacionClase;
    }
    // ------------------------------------------------------------------------
    ...
    public void iniciarNavegacion(int velocidad, String rumbo, String nombreDelPatron, int numDeTripulantes) {
        ...
        if (velocidad < Velero1.MIN_VELOCIDAD || velocidad > Velero1.MAX_VELOCIDAD) {
        ...
        if (numDeTripulantes < Velero1.MIN_TRIPULANTES || numDeTripulantes > this.maxTripulantes) {
            throw new IllegalArgumentException(String.format("El número de tripulantes debe estar entre %d y %d.", Velero1.MIN_TRIPULANTES, this.maxTripulantes));
        }
        ...
        Velero1.numDeVelerosNavegandoClase++;
    }
    ...
    public void pararNavegacion(int tiempoNavegando) {
        ...
        Velero1.numDeVelerosNavegandoClase--;
        Velero1.tiempoTotalDeNavegacionClase += tiempoNavegando;
    }
     ...
     */
    public String iniciarRegata(Velero1 oponente) {
